...
///
/// Conformance of the `XCoordinationRequestProtocol` of the `SettingsFlowCoordinator`
///
extension SettingsFlowCoordinator: XCoordinationRequestProtocol {
    ...
    func coordinate(from feature: XCoordinator.XCoordinated, request: XCoordinator.XCoordinationRequest) {
        ...
        default:
            logger.debug("""
                SettingsFlowCoordinator: Nothing to coordinate for feature \(feature.rawValue)
