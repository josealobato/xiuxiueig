...
struct QueueFlowView: View {

    @ObservedObject var coordinator: QueueFlowCoordinator

    init(coordinator: QueueFlowCoordinator) {
    ...
    var body: some View {
        ...
        NavigationStack(path: $coordinator.path) {
            coordinator.baseCoordinatorView()
                .navigationDestination(for: QueueFlowCoordinator.Feature.self) { page in
